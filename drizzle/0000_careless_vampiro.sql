...
--> statement-breakpoint
CREATE INDEX `companies_cnpj_idx` ON `companies` (`cnpj`);--> statement-breakpoint
CREATE INDEX `declarations_companyId_idx` ON `declarations` (`companyId`);--> statement-breakpoint
CREATE INDEX `declarations_proposalId_idx` ON `declarations` (`proposalId`);--> statement-breakpoint
CREATE INDEX `documents_companyId_idx` ON `documents` (`companyId`);--> statement-breakpoint
CREATE INDEX `products_companyId_idx` ON `products` (`companyId`);--> statement-breakpoint
CREATE INDEX `proposals_companyId_idx` ON `proposals` (`companyId`);--> statement-breakpoint
CREATE INDEX `proposals_tenderId_idx` ON `proposals` (`tenderId`);--> statement-breakpoint
...
CREATE INDEX `user_companies_userId_idx` ON `user_companies` (`userId`);--> statement-breakpoint
